...
const parseGlslValidatorResponse = (inputs, output, firstRowRange) =>
    new Promise(resolve => {
        const toReturn = [];
            ...
            atom.config.observe(
                ...
                glslangValidatorPath => {
                    ...
                    if (
                        ...
                        try {
                            state.glslangValidatorPath = which_1.default.sync(
                                glslangValidatorPath
                            );
                        } catch (error) {
                            console.log(error);
                    ...
                    if (state.glslangValidatorPath) {
                        ...
                        if (!state.messages) {
                            state.messages = new atom_message_panel_1.MessagePanelView(
                                {
    ...
    provideLinter() {
        ...
        return {
            ...
            lint: editor => {
                ...
                let args = [];
                return helpers
                    .tempFiles(filesToValidate, files =>
